...
con_pass = Entry(frame, width=25, fg='black', border=0, bg='white', font=('Microsoft YaHei UI Light', 11))
...
signin = Button(frame, width=6, text='Sign in', border=0,command=signup, bg='white',cursor='hand2', fg='#57a1f8')
